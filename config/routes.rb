Rails.application.routes.draw do
  ...
  scope :api do
    scope :v1 do
      ...
      get "users/:establishment_id/:role" => "api/v1/users#by_establishment_and_role"
      ...
      get 'scheduling/:product_id/:date' => 'api/v1/scheduling#by_service_and_date'
      ...
      scope :private do
        ...
        get "/show_by_user" => "api/v1/private/scheduling#show_by_user"
