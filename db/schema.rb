...
ActiveRecord::Schema.define(version: 2020_07_05_102223) do
  ...
  create_table "addresses", force: :cascade do |t|
    ...
    t.decimal "long"
    t.decimal "lat"
    t.geography "geolocal", limit: {:srid=>4326, :type=>"st_point", :geographic=>true}
    t.index ["establishment_id"], name: "index_addresses_on_establishment_id"
    t.index ["geolocal"], name: "index_addresses_on_geolocal", using: :gist
  end
